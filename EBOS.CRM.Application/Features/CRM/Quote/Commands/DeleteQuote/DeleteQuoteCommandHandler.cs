...
public class DeleteQuoteCommandHandler(IQuoteRepository repository, IAuditService auditService,
    ICurrentUserContext currentUser) : IRequestHandler<DeleteQuoteCommand, bool>
{

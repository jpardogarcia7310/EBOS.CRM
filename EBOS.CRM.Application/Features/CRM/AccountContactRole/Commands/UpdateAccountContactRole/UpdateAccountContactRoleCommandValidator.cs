...
public class UpdateAccountContactRoleCommandValidator : AbstractValidator<UpdateAccountContactRoleCommand>
{
    public UpdateAccountContactRoleCommandValidator()
    {

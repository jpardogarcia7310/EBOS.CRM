...
public class DeleteCaseCommandHandler(ICaseRepository repository, IAuditService auditService,
    ICurrentUserContext currentUser) : IRequestHandler<DeleteCaseCommand, bool>
{

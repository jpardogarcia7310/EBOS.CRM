...
public class UpdateCustomerCommandValidator : AbstractValidator<UpdateCustomerCommand>
{
    ...
    public UpdateCustomerCommandValidator(IValidationCatalogService validationCatalog)
    {
    ...
    private async Task<bool> PhoneMatchesDefaultAsync(global::EBOS.CRM.Contracts.Requests.CRM.Customer.UpdateCustomerRequest request,

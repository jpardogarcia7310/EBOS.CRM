...
using EBOS.CRM.Application.Features.CRM.AccountContact.Services;
using EBOS.CRM.Application.Features.CRM.AccountContactRole.Services;
using EBOS.CRM.Application.Features.CRM.AccountHierarchy.Services;
...
public static class DependencyInjection
{
    public static IServiceCollection AddApplication(this IServiceCollection services)
    {
        ...
        services.AddScoped<IAccountContactReferenceValidationService, AccountContactReferenceValidationService>();
        services.AddScoped<IAccountContactRoleReferenceValidationService, AccountContactRoleReferenceValidationService>();
        services.AddScoped<IAccountHierarchyReferenceValidationService, AccountHierarchyReferenceValidationService>();
        ...
        services.AddScoped<ITenantOperationalValidationService, TenantOperationalValidationService>();

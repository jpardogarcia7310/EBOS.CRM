...
public class EstadoRepository : IEstadoRepository
{
    ...
    public EstadoRepository(CrmDbContext context)
    {
    ...
    #region Queries
    public async Task<Estado?> GetByIdAsync(long id, CancellationToken cancellationToken = default)
    {
        var result = await _dbSet.FirstOrDefaultAsync(c => c.Id == id, cancellationToken);
        return result;
    }

    public async Task<ICollection<Estado>> GetAllAsync(CancellationToken cancellationToken = default)
    {

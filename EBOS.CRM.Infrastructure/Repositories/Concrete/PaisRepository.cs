...
public class PaisRepository : IPaisRepository
{
    ...
    private readonly DbSet<Pais> _dbSet;
    private IDbContextTransaction? _currentTransaction;

    public PaisRepository(CrmDbContext context)
    {
    ...
    #region Queries
    public async Task<Pais?> GetByIdAsync(long id, CancellationToken cancellationToken = default)
    {
        return await _dbSet.FirstOrDefaultAsync(c => c.Id == id, cancellationToken);
    }

    public async Task<ICollection<Pais>> GetAllAsync(CancellationToken cancellationToken = default)
    {

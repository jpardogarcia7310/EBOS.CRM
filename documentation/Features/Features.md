Enterprise scope definition (Sales, Service, Marketing), with a GitHub-ready roadmap with estimates per task.

•Sales: Lead → Opportunity → Quote → Order/Contract → Renewal. Forecast, pipeline, team/territories,
approval rules, discounts.
...
Checklist prioritized by module (Levels + Impact/Effort)
Legend levels: MVP, Enterprise, Best‑in‑Class.
...
Roadmap for GitHub (lists with estimated effort)
Format: M (1–2 weeks), L (3–5 weeks), XL (6–10 weeks).

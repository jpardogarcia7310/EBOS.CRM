...
namespace EBOS.CRM.ApiTests.Controllers.CRM.Service;

public class CaseActivityControllerTest(CaseActivityControllerTest.CaseActivityTestFactory factory) :
    IClassFixture<CaseActivityControllerTest.CaseActivityTestFactory>
{
    ...
    public sealed class CaseActivityTestFactory : CustomWebApplicationFactory<Program>
    {

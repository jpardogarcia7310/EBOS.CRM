...
public class QualifyLeadCommandHandlerTest
{
    [Fact]
    public async Task Handle_WhenNotFound_ReturnsNull()
    {
        ...
        var handler = new QualifyLeadCommandHandler(repository.Object, audit.Object, currentUser.Object);
        var result = await handler.Handle(new QualifyLeadCommand(404, new QualifyLeadRequest(1, "notes")), CancellationToken.None);
        Assert.Null(result);
    }
    ...
    public async Task Handle_WhenValid_UpdatesStatus()
    {
        ...
        var handler = new QualifyLeadCommandHandler(repository.Object, audit.Object, currentUser.Object);
        var result = await handler.Handle(new QualifyLeadCommand(1, new QualifyLeadRequest(1, "good lead")), CancellationToken.None);

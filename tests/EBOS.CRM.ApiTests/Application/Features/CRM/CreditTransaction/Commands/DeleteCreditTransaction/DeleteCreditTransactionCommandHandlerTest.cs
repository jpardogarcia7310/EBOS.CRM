...
public class DeleteCreditTransactionCommandHandlerTest
{
    private readonly Mock<ICreditTransactionRepository> _repositoryMock;
    private readonly Mock<IAuditService> _auditServiceMock;
    private readonly DeleteCreditTransactionCommandHandler _handler;

    public DeleteCreditTransactionCommandHandlerTest()
    {
        ...
        _handler = new DeleteCreditTransactionCommandHandler(
    ...
    public async Task Handle_WhenEntityNotFound_ReturnsFalse()
    {
        ...
        var result = await _handler.Handle(new DeleteCreditTransactionCommand(1), CancellationToken.None);
    ...
    public async Task Handle_WhenSaveChangesThrows_RollsBack()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(() =>
            _handler.Handle(new DeleteCreditTransactionCommand(1), CancellationToken.None));

...
public class UpdateBranchOfficeAddressCommandHandlerTest
{
    ...
    private readonly Mock<IBranchOfficeAddressReferenceValidationService> _referenceValidationMock;
    ...
    public UpdateBranchOfficeAddressCommandHandlerTest()
    {
        ...
        _referenceValidationMock = new Mock<IBranchOfficeAddressReferenceValidationService>();
    ...
    public async Task Handle_WhenEntityFound_UpdatesAndAudits()
    {
        ...
        _referenceValidationMock
            .Setup(x => x.EnsureDependenciesAvailableAsync(request.TenantId, request.BranchOfficeId, request.AddressId, It.IsAny<CancellationToken>()))
        ...
        var result = await _handler.Handle(new UpdateBranchOfficeAddressCommand(1, request), CancellationToken.None);
    ...
    public async Task Handle_WhenSaveChangesThrows_RollsBack()
    {
        ...
        await Assert.ThrowsAsync<InvalidOperationException>(() =>
            _handler.Handle(new UpdateBranchOfficeAddressCommand(1, request), CancellationToken.None));

...
public class AddressTypeErrorHandlingTests : IClassFixture<AddressTypeErrorHandlingTests.FailingAddressTypeFactory>
{
    private readonly HttpClient _client;

    public AddressTypeErrorHandlingTests(FailingAddressTypeFactory factory)
    {
        ...
        protected override void ConfigureWebHost(IWebHostBuilder builder)
        {
            ...
            builder.ConfigureServices(services =>
            {
                var descriptor = services.SingleOrDefault(
                    d => d.ServiceType == typeof(IAddressTypeRepository));
                if (descriptor != null)
                {

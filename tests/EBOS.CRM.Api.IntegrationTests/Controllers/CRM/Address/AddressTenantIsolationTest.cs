...
public class AddressTenantIsolationTest : IClassFixture<CustomWebApplicationFactory>
{
    ...
    public async Task GetAll_Filters_By_Tenant_Header()
    {
        ...
        SeedAddresses(streetTenant1, streetTenant2);

        var clientTenant1 = CreateClientWithTenant(1);
        ...
        itemsTenant1.Should().Contain(i => i.Street == streetTenant1);
        itemsTenant1.Should().NotContain(i => i.Street == streetTenant2);

        var clientTenant2 = CreateClientWithTenant(2);
    ...
    private (long Tenant1Id, long Tenant2Id) SeedAddresses(string streetTenant1, string streetTenant2)
    {
    ...
    private HttpClient CreateClientWithTenant(long tenantId)
    {

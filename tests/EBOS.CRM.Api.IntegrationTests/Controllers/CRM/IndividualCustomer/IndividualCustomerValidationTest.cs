...
public class IndividualCustomerValidationTest(CustomWebApplicationFactory factory) : IClassFixture<CustomWebApplicationFactory>
{
    ...
    {
        var response = await _client.GetAsync($"/api/v{_version}/IndividualCustomer/-1");

...
public class CustomerAddressValidationTest(CustomWebApplicationFactory factory) : IClassFixture<CustomWebApplicationFactory>
{
    ...
    {
        var response = await _client.GetAsync($"/api/v{_version}/CustomerAddress/-1");

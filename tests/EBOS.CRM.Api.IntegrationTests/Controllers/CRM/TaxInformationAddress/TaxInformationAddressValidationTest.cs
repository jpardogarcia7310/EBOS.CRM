...
public class TaxInformationAddressValidationTest(CustomWebApplicationFactory factory) : IClassFixture<CustomWebApplicationFactory>
{
    ...
    {
        var response = await _client.GetAsync($"/api/v{_version}/TaxInformationAddress/-1");

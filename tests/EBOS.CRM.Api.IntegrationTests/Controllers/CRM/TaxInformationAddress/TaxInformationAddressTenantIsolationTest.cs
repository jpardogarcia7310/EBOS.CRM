...
public class TaxInformationAddressTenantIsolationTest : IClassFixture<CustomWebApplicationFactory>
{
    ...
    private void SeedTaxInformationAddresses(out (long TaxInformationAddress1Id, long TaxInformationAddress2Id, long Address1Id, long Address2Id, long ErasedAddressId) data)
    {
        ...
        db.TaxInformation.AddRange(tax1, tax2);
        db.SaveChanges();
        ...
        var link1 = new CRMTaxInformationAddress
        {
            TenantId = 1,
            TaxInformationId = tax1.Id,
        ...
        var link2 = new CRMTaxInformationAddress
        {
            TenantId = 2,
            TaxInformationId = tax2.Id,
        ...
        var linkErased = new CRMTaxInformationAddress
        {
            TenantId = 1,
            TaxInformationId = tax1.Id,
        ...
        db.Set<CRMTaxInformationAddress>().AddRange(link1, link2, linkErased);
        db.SaveChanges();
